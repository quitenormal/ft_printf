...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2022/10/24 20:48:57 by yjirapin          #+#    #+#             */
/*   Updated: 2022/10/28 18:37:52 by yjirapin         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "libft.h"

void	ft_putunsigned_int(unsigned int n, int fd)
{
	if (n < 10)
		ft_putchar_fd(n + '0', fd);
	else
	{
		ft_putunsigned_int(n / 10, fd);
		ft_putunsigned_int(n % 10, fd);
	}
}
